...
function [psth, bins, rasterX, rasterY, spikeCounts, binnedArray] = phase_normed_psthAndBA(spikeTimes, eventTimes, window, psthBinSize)
...
spikeTimes = spikeTimes(spikeTimes>min(eventTimes) & spikeTimes<max(eventTimes+2)); % from first evernt to last event + 2s
