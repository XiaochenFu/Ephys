function [stimuli_grouped_j_subset,onset_subset] = pick_stimuli_with_trigger_latency(stimuli_grouped_j,latency_min_ms,latency_max_ms)
try
    LatencyFromCalculatedSniffOnset_ms = extractfield(stimuli_grouped_j,'LatencyFromSniffTrigger_ms');
