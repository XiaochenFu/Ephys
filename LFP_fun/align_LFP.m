function [zscored_data, aligned_data, aligned_baseline] = align_LFP(data,tetrode_time,stim_grouped_j,SNF_OST,varargin)
% based on
...
if saveplot
    saveimg(gcf,'C:\Users\yycxx\OneDrive - OIST\Ephys_Code\Test_Figure','LFPtest','eachStim','1')
end
...
zscored_data{2} = (x5_std-x6)./x6_std;