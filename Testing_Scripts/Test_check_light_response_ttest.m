...
load('C:\Users\yycxx\OneDrive - OIST\Ephys_Code\Tbx284\Good_Units\Tbx_284_Tract1_Depth935_IntensityTrigger_unit28.mat')
...
% light_evoked = check_light_response_ttest(spiketime,stim_group,sniff_onset_spike2_aligned,option);
light_evoked = check_light_response_ttest(spiketime,stim_grouped,sniff_onset_spike2_aligned,option)
% close all
